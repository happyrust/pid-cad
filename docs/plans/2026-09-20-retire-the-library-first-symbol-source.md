...
| 顺手退役 `OCS_PID_LAYER_MODE` | 另一条线（09-07 计划遗留，等 DXF 下游消费方定用法），不混进来。**2026-09-21 另开单** `2026-09-21-the-layer-slot-takes-the-sheet-layer-by-default-and-the-switch-retires.md`，**2026-09-22 该单已落地**（开关退役，槽一律取图纸图层） |
