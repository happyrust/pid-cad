...
impl Pipeline {
    pub fn new(device: &wgpu::Device, queue: &wgpu::Queue, format: wgpu::TextureFormat) -> Self {
        ...
        // wgpu 30 takes each vertex-buffer slot as an `Option`, hence the
        // `Some(..)` around every layout here.
        let block_wire_buffers: &[Option<wgpu::VertexBufferLayout<'_>>] =
            if wire_mode.uses_storage() {
                &[Some(wire_gpu::BlockWireInstance::layout())]
            } else {
                &[
                    Some(wire_gpu::BlockWireVertex::layout()),
                    Some(wire_gpu::BlockWireInstance::layout()),
                ]
            };
        ...
        let wipeout_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            vertex: wgpu::VertexState {
                ...
                entry_point: Some("vs_main"),
                buffers: &[
                    Some(wipeout_gpu::HatchVertex::layout()),
                    Some(wipeout_gpu::WipeoutPlacement::layout()),
                ],
                compilation_options: wgpu::PipelineCompilationOptions::default(),
            },
            primitive: wgpu::PrimitiveState {
        ...
        let shadow_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            vertex: wgpu::VertexState {
                ...
                entry_point: Some("vs_main"),
                buffers: &[
                    Some(mesh_gpu::MeshVertex::layout()),
                    Some(mesh_gpu::MeshInstanceGpu::layout()),
                ],
                compilation_options: wgpu::PipelineCompilationOptions::default(),
            },
            primitive: wgpu::PrimitiveState {
        ...
        let shadow_plain_pipeline =
            device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
                ...
                vertex: wgpu::VertexState {
                    ...
                    entry_point: Some("vs_main"),
                    buffers: &[
                        Some(mesh_gpu::MeshPlainVertex::layout()),
                        Some(mesh_gpu::MeshInstanceGpu::layout()),
                    ],
                    compilation_options: wgpu::PipelineCompilationOptions::default(),
                },
        ...
        | {
            device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
                ...
                vertex: wgpu::VertexState {
                    ...
                    buffers: &[Some(vertex_layout), Some(mesh_gpu::MeshInstanceGpu::layout())],
                    compilation_options: wgpu::PipelineCompilationOptions::default(),
                },
                primitive: wgpu::PrimitiveState {
        ...
        let make_silhouette_pipeline = |label: &'static str, fragment: &'static str| {
            device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
                ...
                vertex: wgpu::VertexState {
                    ...
                    entry_point: Some("vs_main"),
                    buffers: &[
                        Some(mesh_gpu::SilhouetteVertex::layout()),
                        Some(mesh_gpu::SilhouetteInstance::layout()),
                    ],
                    compilation_options: wgpu::PipelineCompilationOptions::default(),
                },
                primitive: wgpu::PrimitiveState {
        ...
        | {
            device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
                ...
                vertex: wgpu::VertexState {
                    ...
                    entry_point: Some("vs_main"),
                    buffers: &[
                        Some(face3d_gpu::Face3DVertex::layout()),
                        Some(face3d_gpu::Face3DInstance::layout()),
                    ],
                    compilation_options: wgpu::PipelineCompilationOptions::default(),
                },
                primitive: wgpu::PrimitiveState {
        ...
        let image_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            vertex: wgpu::VertexState {
                ...
                entry_point: Some("vs_main"),
                buffers: &[
                    Some(image_gpu::ImageVertex::layout()),
                    Some(image_gpu::ImageInstance::layout()),
                ],
                compilation_options: wgpu::PipelineCompilationOptions::default(),
            },
            primitive: wgpu::PrimitiveState {
