...
pub(super) fn message_attribute(source: &str) -> Option<(&'static str, &'static str)> {
    match source {
        ...
        "Export SVG" => Some(("plot", "export-svg")),
        ...
        "Find P&ID Tag" => Some(("common", "find-p-id-tag")),
        ...
        "Group as P&ID Symbol" => Some(("common", "group-as-p-id-symbol")),
        ...
        "Item tag" => Some(("properties", "item-tag")),
        "JIS" => Some(("common", "jis")),
        ...
        "Line number" => Some(("properties", "line-number")),
        ...
        "Role" => Some(("properties", "role")),
        "Sheet layers" => Some(("layers", "sheet-layers")),
        "Roles" => Some(("layers", "roles")),
        "Sheet layer {} turned {} ({} entities)" => Some(("layers", "sheet-layer-turned-entities")),
        ...
        "Multi-page SVG export is not available in the web version; EXPORTSVG downloads the current layout." => Some(("plot", "multi-page-svg-export-is-not-available-in-the-w")),
        ...
        "SVG has no plot stamp: it is device text in a font the file would not carry." => Some(("plot", "svg-has-no-plot-stamp-it-is-device-text-in-a-f")),
        "Save to SVG file…" => Some(("plot", "save-to-svg-file")),
        ...
        "Tag" => Some(("common", "tag")),
        "Tag source" => Some(("common", "tag-source")),
