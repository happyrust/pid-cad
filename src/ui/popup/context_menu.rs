...
pub enum MenuContext {
    ...
    Idle {
        has_selection: bool,
        /// Some selected entity already belongs to a P&ID symbol group, so
        /// the menu offers to take it apart (PIDGROUP OFF).
        selection_in_group: bool,
...
fn idle_rows(
    ...
    if has_selection {
        ...
        // P&ID symbol groups (io::pid_legend): make the selection one symbol
        // by hand, or take a placed symbol apart again.
